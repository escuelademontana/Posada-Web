...
const rooms = [
  {
    ...
    slides: [
      { src: "/assets/rooms/doble-carpintero-1.jpg", alt: "Habitación doble Carpintero con cama matrimonial" },
      { src: "/assets/rooms/doble-carpintero-2.jpg", alt: "Vista de la habitación doble Carpintero" },
      { src: "/assets/rooms/doble-zorzal-1.jpg", alt: "Habitación doble Zorzal con cama matrimonial" },
      { src: "/assets/rooms/doble-zorzal-2.jpg", alt: "Detalle de la habitación doble Zorzal" },
    ],
  },
  {
    ...
    slides: [
      { src: "/assets/rooms/cuadruple-halcon-1.jpg", alt: "Suite cuádruple Halcón con cama principal" },
      { src: "/assets/rooms/cuadruple-halcon-doble.jpg", alt: "Dormitorio doble de la suite cuádruple Halcón" },
      { src: "/assets/rooms/cuadruple-halcon-tercer-cama.jpg", alt: "Tercera cama de la suite cuádruple Halcón" },
      { src: "/assets/rooms/cuadruple-chucao-1.jpg", alt: "Suite cuádruple Chucao" },
      { src: "/assets/rooms/cuadruple-chingolo-1.jpg", alt: "Suite cuádruple Chingolo" },
      { src: "/assets/rooms/cuadruple-colibri-1.jpg", alt: "Suite cuádruple Colibrí" },
      { src: "/assets/rooms/cuadruple-colibri-2.jpg", alt: "Vista adicional de la suite cuádruple Colibrí" },
    ],
  },
];
